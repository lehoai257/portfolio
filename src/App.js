  ...
  const infoSectionData = [
    {
      ...
      desscription: "Since beginning my journey as a DevOps Engineer nearly 7 years ago, I have been working for FPT Software and SBIFPT and collaborating with talented people to create digital products for both business and consumer use. I'm quietly confident, naturally curious, and perpetually working on improving my chops one developed problem at a time.",
